<template>
	<div>
		...
		<section>
			<h2>제1조(목적)</h2>
			<p>
				이 약관은 진담(전자상거래 사업자)이 운영하는 진담헤어 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를
		...
		<section>
			<h2>제2조(정의)</h2>
			<p>
				① "몰"이란 진담이 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수
				있도록 설정한 가상의 영업장을 말하며, 아울러 "몰"을 운영하는 사업자의 의미로도 사용합니다.
			</p>
		...
		<section>
			...
			<p>
				① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 사업자등록번호,
				통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 진담의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가
		...
		<section>
			...
			<ul>
				<li>
					<p>
						- 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조 제3항에 의한 회원자격 상실 후 3년이
						경과한 자로서 "몰"의 회원재가입 승낙을 얻은 경우에는 예외로 한다.
					</p>
				</li>
				<li><p>- 등록 내용에 허위, 기재누락, 오기가 있는 경우</p></li>
				<li><p>- 기타 회원으로 등록하는 것이 "몰"의 기술상 현저히 지장이 있다고 판단되는 경우</p></li>
			</ul>
		...
		<section>
			...
			<ul>
				...
				<li><p>- "몰"을 이용하여 구입한 재화 등의 대금, 기타 "몰"이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우</p></li>
				<li><p>- 다른 사람의 "몰" 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우</p></li>
				<li><p>- "몰"을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</p></li>
			</ul>
			<p>
		...
		<section>
			...
			<p>
				② "몰"은 불특정다수 회원에 대한 통지의 경우 1주일 이상 "몰" 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와
		...
		<section>
			...
			<ul>
				...
				<li><p>- 이 약관에 동의하고 위 -호의 사항을 확인하거나 거부하는 표시(예, 마우스 클릭)</p></li>
				<li><p>- 재화등의 구매신청 및 이에 관한 확인 또는 "몰"의 확인에 대한 동의</p></li>
				<li><p>- 결제방법의 선택</p></li>
			</ul>
			<p>
				② "몰"이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도
				같습니다.)
			</p>
			<ul>
				<li><p>- 신청 내용에 허위, 기재누락, 오기가 있는 경우</p></li>
				<li><p>- 미성년자가 담배, 주류 등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우</p></li>
				<li><p>- 기타 구매신청에 승낙하는 것이 "몰" 기술상 현저히 지장이 있다고 판단하는 경우</p></li>
			</ul>
		...
		<section>
			...
			<ul>
				...
				<li><p>- 수령 시 대금지급</p></li>
				<li><p>- 마일리지 등 "몰"이 지급한 포인트에 의한 결제</p></li>
				<li><p>- "몰"과 계약을 맺었거나 "몰"이 인정한 상품권에 의한 결제</p></li>
		...
		<section>
			...
			<ul>
				<li>
					- 이용자에게 책임 있는 사유로 재화 등이 멸실 또는 훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장 등을 훼손한 경우에는 청약철회를 할
					수 있습니다)
				</li>
